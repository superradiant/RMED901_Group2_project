...
```
The next part of the script generates two new columns `changeincough` and `changeinpain`, which reveal if the severity of cough throat pain changed, respectively.
...
```
For patient ID's 113 and 123, no data were collected in the columns with the missing entries.
```{r}
